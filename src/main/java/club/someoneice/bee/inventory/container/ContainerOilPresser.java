...
public class ContainerOilPresser extends Container {
    public SimpleInventory inventory;
    private World worldObj;
    private ChunkPosition pos;

    public ContainerOilPresser(InventoryPlayer player, World world, int x, int y, int z, TileOilPresser tile) {
        this.worldObj = world;
        this.pos = new ChunkPosition(x, y, z);
        inventory = tile.inventory;

        this.addSlotToContainer(new Slot(this.inventory, 0, 56, 53));
        this.addSlotToContainer(new Slot(this.inventory, 1, 46, 17));
        this.addSlotToContainer(new Slot(this.inventory, 2, 66, 17));
        this.addSlotToContainer(new Slot(this.inventory, 3, 83, 53));
        this.addSlotToContainer(new SlotOutput(this.inventory, 4, 129, 53));
